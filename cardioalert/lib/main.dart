import 'package:cardioalert/constants.dart';
import 'package:cardioalert/home_screen.dart';
...
class AuthWidget extends StatelessWidget {
        ...
        return SignInScreen(
          subtitleBuilder: (context, action) {
            ...
            return Padding(
              ...
              child: Text('Welcome to CardioAlert! $actionText.'),
            );
          },
  ...
  void _createUserDocument(User user) {
    FirebaseFirestore.instance.collection('cardioalertUsers').doc(user.uid).set({
      'userId': user.uid,
      'userAlias': "User",
      'userName': "User",
